...
def main():
    ...
    #     message = input("Введите сообщение для отправки: ") #получаем входную строку
    ...
    #         print(f"decoded message: {convert_int_to_chars(div_str_to_numbers(num))}")
